...
fun main() {
    val folder = File("/Users/raul/Documents/raul/project/argonaut-mc/argonaut/src/main/kotlin") // 대상 폴더의 경로를 여기에 넣어주세요
    val filesMap = collectFiles(folder)

    for ((path, file) in filesMap) {
        println("Relative Path: $path, File: $file")
    }
}